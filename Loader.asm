...
err  db "Sekt",148,"rde ge",135,"ersiz veri: 2, silindir: 0, head: 0 - b",154,"t",154,"nl",154,"k kontrol",154," ba",159,"ar",141,"s",141,"z.", 0Dh,0Ah
     db "O",167,"retici 11'e bak",141,"n - Kendi i",159,"letim sisteminizi yap",141,"n.", 0Dh,0Ah
     db "Sistem ",159,"imdi yeni ba",159,"layacak. Herhangi bir tu",159,"a bas",141,"n",141,"z...", 0
